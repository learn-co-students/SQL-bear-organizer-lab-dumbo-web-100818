...
## if writing sql commands in ruby, and calling a string, must use single quotes for specific string and double quotes for command.
...
## this is a GROUP BY command ^^ pay attention to syntax
